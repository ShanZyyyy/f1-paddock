...
CATALOG: list[IntentDef] = [
    ...
    IntentDef("SEASON_CHAMPION",
              ...
              needs=("year",)),
    IntentDef("SEASON_CALENDAR",
              keywords=("takvim", "pistleri say", "pistleri sayar", "kac yaris",
                        "kac pist", "hangi yarislar", "yarislari say", "hangi pistler",
                        "yaris listesi", "yarislar neler", "kac tane yaris"),
              strong=("pistleri say", "takvimi", "kac yaris vardi", "hangi yarislar vardi"),
              needs=("year",)),
    IntentDef("SEASON_FIRST_LAST",
              keywords=("ilk yaris", "ilk yarisi", "son yaris", "son yarisi",
                        "nerede basladi", "nerede bitti", "sezon nerede", "acilis yarisi",
                        "kapanis yarisi", "ilk yari", "sezonun ilki"),
              strong=("ilk yarisi nerede", "ilk yari nerede", "nerede basladi",
                      "son yarisi nerede", "nerede bitti"),
              needs=("year",)),
    IntentDef("STANDINGS",
