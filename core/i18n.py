...
STRINGS = {
    ...
    "nav.live": {"tr": "Seans Merkezi", "en": "Session Centre"},
    ...
    "page.live.title": {"tr": "Seans Merkezi", "en": "Session Centre"},
    "page.live.sub": {"tr": "Tamamlanan seansların doğrulanmış sonuçları ve tam 2D yarış tekrarları — canlı zamanlama saati ana ekranda. Canlı konum takibi yol haritasında.",
                      "en": "Verified results from completed sessions and full 2D race replays — the live countdown is on the home screen. Live position tracking is on the roadmap."},
    ...
    "page.games.sub": {"tr": "Altı oyun, hepsi doğrulanmış FastF1 verisiyle — kariyer istatistikleri, sıralama turları, yarış sonuçları.",
                       "en": "Six games, all on verified FastF1 data — career stats, qualifying laps, race results."},
