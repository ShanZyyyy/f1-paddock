...
STRINGS = {
    ...
    "page.games.sub": {"tr": "Stewardle gerçek kariyer verisiyle çalışır; Paddock Career tamamen bir simülasyondur.",
                       "en": "Stewardle uses real career data; Paddock Career is a full simulation."},
